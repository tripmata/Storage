...
//------------------------------   Role Operatons ----------------------------------//
	function saveRole()
	{
		let request = {
			...
			staff_read:getElement("staff-read").checked,
			rooms_read:getElement("rooms-read").checked,
			kitchen_read:getElement("kitchen-read").checked,
			bakery_read:getElement("bakery-read").checked,
			bar_read:getElement("bar-read").checked,
			laundry_read:getElement("laundry-read").checked,
			housekeeping_read:getElement("housekeeping-read").checked,
			pool_read:getElement("pool-read").checked,
			store_read:getElement("store-read").checked,
			event_read:getElement("event-read").checked,
			finance_read:getElement("finance-read").checked,
			branch_read:getElement("branch-read").checked,
			log_read:getElement("log-read").checked,
			reporting_read:getElement("reporting-read").checked,
			messaging_read:getElement("messaging-read").checked,
			webfront_read:getElement("webfront-read").checked,
			webconfig_read:getElement("webconfig-read").checked,
			...
			staff_write:getElement("staff-write").checked,
			rooms_write:getElement("rooms-write").checked,
			kitchen_write:getElement("kitchen-write").checked,
			bakery_write:getElement("bakery-write").checked,
			bar_write:getElement("bar-write").checked,
			laundry_write:getElement("laundry-write").checked,
			housekeeping_write:getElement("housekeeping-write").checked,
			pool_write:getElement("pool-write").checked,
			store_write:getElement("store-write").checked,
			event_write:getElement("event-write").checked,
			finance_write:getElement("finance-write").checked,
			branch_write:getElement("branch-write").checked,
			log_write:getElement("log-write").checked,
			reporting_write:getElement("reporting-write").checked,
			messaging_write:getElement("messaging-write").checked,
			webfront_write:getElement("webfront-write").checked,
			webconfig_write:getElement("webconfig-write").checked,
		...
		{
			request.frontdesk = getElement("frontdesk").checked;
		}
				...
				if(status === "done")
				{
					...
					if(d.Status === "success")
					{
						if(d.Data === "success")
						{
							...
							setTimeout(function(){
								location.hash = "#admin-group-role";
							},3000);
						}
						else
						{
	...
	function loadEditRole(e)
	{
		...
		postJson("hms-admin/worker", function(data, status){
			...
			if(status === "done")
			{
				...
				if(d.Status === "success")
				{
					getElement("role-name").value = d.Data.Name;
					getElement("role-id").value = d.Data.Id;
					getElement("booking-read").checked = d.Data.Booking.ReadAccess;
					getElement("coupon-read").checked = d.Data.Discount.ReadAccess;
					getElement("customer-read").checked = d.Data.Customers.ReadAccess;
					getElement("staff-read").checked = d.Data.Staff.ReadAccess;
					getElement("rooms-read").checked = d.Data.Rooms.ReadAccess;
					getElement("kitchen-read").checked = d.Data.Kitchen.ReadAccess;
					getElement("bakery-read").checked = d.Data.Bakery.ReadAccess;
					getElement("bar-read").checked = d.Data.Bar.ReadAccess;
					getElement("laundry-read").checked = d.Data.Laundry.ReadAccess;
					getElement("housekeeping-read").checked = d.Data.Housekeeping.ReadAccess;
					getElement("pool-read").checked = d.Data.Pool.ReadAccess;
					getElement("store-read").checked = d.Data.Store.ReadAccess;
					getElement("event-read").checked = d.Data.Event.ReadAccess;
					getElement("finance-read").checked = d.Data.Finance.ReadAccess;
					getElement("branch-read").checked = d.Data.Branch.ReadAccess;
					getElement("log-read").checked = d.Data.Log.ReadAccess;
					getElement("reporting-read").checked = d.Data.Report.ReadAccess;
					getElement("messaging-read").checked = d.Data.Messaging.ReadAccess;
					getElement("webfront-read").checked = d.Data.Webfront.ReadAccess;
					getElement("webconfig-read").checked = d.Data.Webconfig.ReadAccess;
					getElement("settings-read").checked = d.Data.Settings.ReadAccess;


					getElement("booking-write").checked = d.Data.Booking.WriteAccess;
					getElement("coupon-write").checked = d.Data.Discount.WriteAccess;
					getElement("customer-write").checked = d.Data.Customers.WriteAccess;
					getElement("staff-write").checked = d.Data.Staff.WriteAccess;
					getElement("rooms-write").checked = d.Data.Rooms.WriteAccess;
					getElement("kitchen-write").checked = d.Data.Kitchen.WriteAccess;
					getElement("bakery-write").checked = d.Data.Bakery.WriteAccess;
					getElement("bar-write").checked = d.Data.Bar.WriteAccess;
					getElement("laundry-write").checked = d.Data.Laundry.WriteAccess;
					getElement("housekeeping-write").checked = d.Data.Housekeeping.WriteAccess;
					getElement("pool-write").checked = d.Data.Pool.WriteAccess;
					getElement("store-write").checked = d.Data.Store.WriteAccess;
					getElement("event-write").checked = d.Data.Event.WriteAccess;
					getElement("finance-write").checked = d.Data.Finance.WriteAccess;
					getElement("branch-write").checked = d.Data.Branch.WriteAccess;
					getElement("log-write").checked = d.Data.Log.WriteAccess;
					getElement("reporting-write").checked = d.Data.Report.WriteAccess;
					getElement("messaging-write").checked = d.Data.Messaging.WriteAccess;
					getElement("webfront-write").checked = d.Data.Webfront.WriteAccess;
					getElement("webconfig-write").checked = d.Data.Webconfig.WriteAccess;
					getElement("settings-write").checked = d.Data.Settings.WriteAccess;
...
//-----------------  Customers Logic -----------------------------------------------------------//
				...
				if(status === "done")
				{
					...
					if(d.Status === "success")
					{
						...
						setTimeout(function(){
							...
							$("#save-dept-btn").html("<i class='save icon'></i> Add");
						},3000);
	...
	function editDepartment(id, name)
	{
		...
		"<div class='ui fluid input'><input type='text' value='"+name+"'/></div></div>" +
		"<div class='pad-1' style='background-color: whitesmoke;'><button class='ui blue button'>Save</button></div>"});
	}
	...
	function DepartmentListDelete(e)
	{
		...
		DeleteDepartment(e, function(status, msg){
			...
			if(status == "done")
			{
				...
				setTimeout(function(){
					$('#'+e+'-row').slideUp(500, function(){
						document.getElementById('dept-tbl').removeChild(document.getElementById(e+'-row'));
					});
				}, 2000);
			}
			else
			...
			postJson("hms-admin/worker", function(data, status){
				if(status == "done")
				{
						...
						if(d.Status == "success")
						{
								...
								$("#staff-save-btn").addClass("loading");
								...
								errorButton({msg:"",btn:"staff-save-btn"});
						}
				}
				else {
...
// -------------------------------------- Room category Logic---------------------------------------------------//
	...
	function loadEditRoomCatData(e)
	{
		...
		},{roomcategoryid:e, job:"single room category"});
	}
	...
	function saveCoupon()
	{
		...
		{
			errorButton({btn:"save-coupon-btn", msg:"Copon covers nothing"});
		}
		else
		{
				...
				if (status === "done") {
					...
					if (d.Status === "success")
					{
						...
						setTimeout(function () {
							...
							$("#save-coupon-btn").html("Create coupon");
						}, 3000);
					}
					else
					{
	...
	function saveDiscount()
	{
		...
		let request = {
			...
			bypercent:getElement("bypercentage").checked,
			lodging: sel.options[0].selected ? $("#lodging-select").dropdown("get value") : "",
		...
		if(request.periodic)
		{
			request.fromday = $("#start-day").val();
			request.today = $("#stop-day").val();
		...
		postJson("hms-admin/worker", function(data, status){
			...
			if(status === "done")
			{
				...
				if(d.Status === "success")
				{
					...
					if(d.Data.Periodic)
					{
						$("#start-day").dropdown('set selected', d.Data.Fromday);
						$("#stop-day").dropdown('set selected', d.Data.Today);
