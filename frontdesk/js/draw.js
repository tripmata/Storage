  ...
  function DrawPoolSettings()
  {
      ...
      _page({add:div({add:
                  ...
                  "<div class='l-width-xl w3-card widget curve'>" +
                  "<div class='pad-t'>" +
                  "<label>" +
  ...
  function DrawFoodReport()
  {
      ...
      _page({add:
              ...
              "<div class='widget pad-2 w3-card curve'>" +
              "<div class='w3-row'>" +
              "<div class='w3-col l8 m7 s6'>.</div>" +
              "<div class='w3-col l4 m5 s6 align-r'>" +
              "<h4 class='sleak blue'>Sales position</h4>" +
              "<h2 class='sleak' style='margin: 0px;'>23</h2>" +
              "</div>" +
              "</div>" +
              "</div>" +
              "</div>" +
              ...
              "<div class='widget w3-card curve'>" +
              "<div class='w3-row'>" +
              "<div class='w3-col l6 m6 s6' style=\"background-image: " +
              ...
              "<div class='w3-col l6 m6 s6 pad-2 align-r'>" +
              "<h4 class='sleak blue'>Sold</h4>" +
              "<h2 class='sleak' style='margin: 0px;'>234</h2>" +
              "</div>" +
              "</div>" +
              "</div>" +
              "</div>" +
              ...
              "background-position-x: -35px; background-position-y: -35px; background-repeat: no-repeat;\">.</div>" +
              "<div class='w3-col l6 m6 s6 pad-2 align-r'>" +
              "<h4 class='sleak blue'>Total</h4>" +
              "<h2 class='sleak' style='margin: 0px;'>" +
              "<span style='font-family: Lato; font-weight: normal;'>" +
              $("#currency-symbol").val()+"</span> 23,000</h2>" +
              "</div>" +
              "</div>" +
              "</div>" +
              "</div>" +
      ...
      _page({add:
              ...
              "<button id='plot-customer' class='ui compact sleak right floated blue button' onclick=\"switchDailyPlotType('customer')\">Over period</button>" +
              "<button id='plot-items' class='ui compact sleak right floated button' onclick=\"switchDailyPlotType('items')\">Daily average</button>" +
              "</div>" +
              ...
              "<span class='chart' id='revenue-percentage' data-percent='0' data-scale-color='#00b400'><span class='percent'></span></span>" +

              "</div>" +
              "<div class='pad-1'>" +
              "<h6 class='sleak' style='color: dimgray; text-align: center; font-weight: bold;'>Of Kitchen Revenue</h6> " +
              "</div>" +
              "<br/>" +
  ...
  function DrawCustomers()
  {
      ...
      let searchCon = div({ add: DrawSearch({ method: "populateCustomer" }), class: "l-pad-2" });
      searchCon.style.paddingTop = "0px";
      searchCon.style.paddingBottom = "0px";
      _page({ add: searchCon });
  ...
  function DrawReservations()
  {
      ...
      _page({add: DrawTable(["Reservation Detail", "Payment", "Date", "Amount", "Status", "Action"],
              {
