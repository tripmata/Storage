    ...
    function DrawHome()
    {
        ...
        let vehicleBtn =
            ...
            "                                <div>" +
            "                                    <h5 style='font-family: varela_roundregular; color: dimgray;'>" +
            "                                        <i class='taxi yellow icon'></i> Vehicle listing" +
            "                                    </h5>" +
            "                                    <h6 style='margin: 0; font-family: Lato;'>" +
        ...
        $("#page-1").html(
            ...
            "                        <i class='building blue icon'></i> Properties" +
            "                    </h3>" +
            "                </div>" +
            "            </div>" +
            "            <div class='w3-row'>" +
            ...
            else
            {
                ...
                $("#listing-tab-detail").html("<i class='building blue icon'></i> Properties");
                ...
                if(d.status === "success")
                {
                    if(d.data.length === 0)
                    {
                        $("#page-gig").html(
                            ...
                            "<button class='ui basic sleak button' style='font-weight: bold;'>List a property</button>" +
                            "</a> " +
                            "</div>" +
                            "</div>");
                    }
                    else
                    {
                        for(let i = 0; i < d.data.length; i++)
                        {
                            ...
                            td1.innerHTML = "<img src='files/"+d.data[i].Banner+"' style='width: 80px; border-radius: 4px;'/>";
                            ...
                            td4.innerHTML = "<span style='color: silver;'> Room(s):</span> <span class=''>"+d.data[i].Rooms+"</span><br/>" +
                ...
                if(d.status === "success")
                {
                    if(d.data.length === 0)
                    {
                        $("#page-gig").html(
                            ...
                            "<img src='images/taxi.png' style='width: 100px;'/><br/>" +
                            "<h2 style='color: rgb(230,230,230); font-family: quicksandregular; font-weight: normal;'>" +
                            "You have no leased vehicle yet" +
                            "</h2><br/>" +
                            "<a href='listing#listing'> " +
                            "<button class='ui basic sleak button' style='font-weight: bold;'>Start listing</button>" +
                            "</a> " +
                            "</div>" +
                            "</div>");
                    }
                    else
                    {
                        for(let i = 0; i < d.data.length; i++)
                        {
                            ...
                            let td1 = document.createElement("td");
                            td1.innerHTML = "<img src='files/"+d.data[i].Image1+"' style='width: 80px; border-radius: 4px;'/>";

                            let td2 = document.createElement("td");
                            td2.innerHTML = "<h6 style='margin-bottom: 15px;'>"+
                                d.data[i].Color+" "+d.data[i].Brand+" "+d.data[i].Model+" "+d.data[i].Type+"</h6>"+
                                (d.data[i].Approved ? "<span class='green-back status'>Approved</span>" : "<span class='yellow-back status'>Pending approval</span>");
                            ...
                            td4.innerHTML = "<span style='color: silver;'> Seats:</span> <span class=''>"+d.data[i].Seats+"</span><br/>" +
                                "<span style='color: silver;'> Booking(s):</span> <span class=''>"+0+"</span><br/>" +
                                "<span style='color: silver;'> Views(s):</span> <span class=''>"+d.data[i].Views+"</span><br/>";

                            let td5 = document.createElement("td");
                            td5.innerHTML = (d.data[i].Approved ?
                                "<a href='vehicle/"+d.data[i].Id+"'>" +
                                "<button class='ui basic circular icon large button' style='margin-top: 10px;'>" +
                                "<i class='magic icon' title='canel request'></i> Manage" +
                                "</button>" +
                                "</a>" :
                                "<button class='ui basic disabled circular icon large button' style='margin-top: 10px;'>" +
                                "<i class='magic icon' title='canel request'></i> Manage" +
                                "</button>");
                ...
                if(d.status === "success")
                {
                    if(d.data.length === 0)
                    {
                        $("#page-gig").html(
                            "<div class='align-c'>" +
                            "<div style='margin-top: 90px;'>" +
                            "<img src='images/lease.png' style='width: 100px;'/><br/>" +
                            "<h2 style='color: rgb(230,230,230); font-family: quicksandregular; font-weight: normal;'>" +
    ...
    function drawTicket()
    {
        ...
        p.innerHTML = "<div class='w3-row'>" +
            ...
            "<img class='image' src='images/ticket_3.png' style='width: 40px;'/>" +
            "My Tickets</h4></div>" +
                ...
                if(d.status === "success")
                {
                    ...
                    if(d.data.length === 0)
                    {
                        $("#ticket-con").html(
                            ...
                            "<img src='images/ticket_2.png' style='width: 70px;'/>" +
    ...
    function DrawOpenTicket()
    {
        ...
        p.innerHTML = "<div class='w3-row l-pad-3 m-pad-2 s-pad-t'>" +
            ...
            "<img class='image' src='images/ticket_3.png' style='width: 50px;'/>" +
            "Ticket</h4></div>" +
            "</div>" +
