		...
		postJson("hms-admin/worker", function(data, status){
			...
			if(status === "done")
			{
				...
				if(d.status === "success")
				{
					...
					let gallery = "<div class='pad-t'><img src='../files/"+d.data.Banner+"' style='width: 100%;'/></div>";

					for(let i = 0; i < d.data.Gallery.length; i++)
					{
						gallery += "<div class='w3-col l4 m6 s12'>" +
							"<div class='pad-t'>" +
							"<img src='../files/"+d.data.Gallery[i]+"' style='width: 100%;'/>" +
							"</div>" +
							"</div>";
					}
					$("#property-gallery").html(gallery);

					$("#property-name").val(d.data.Name);
					$("#email1").val(d.data.Email1);
					$("#email2").val(d.data.Email2);
					$("#phone1").val(d.data.Phone1);
					$("#phone2").val(d.data.Phone2);

					$("#address").val(d.data.Address);

					$("#property-city").html("<option value='"+d.data.City.Id+"'>"+d.data.City.Name+"</option>");
					$("#property-state").html("<option value='"+d.data.State.Id+"'>"+d.data.State.Name+"</option>");
		...
		postJson("hms-admin/worker", function(data, status){
			...
			if(status === "done")
			{
				...
				for(let i = 0; i < d.data.Gallery.length; i++)
				{
					gallery += "<div class='w3-col l4 m6 s12'>" +
						"<div class='pad-t'>" +
						"<img src='../files/"+d.data.Gallery[i]+"' style='width: 100%;'/></div>" +
						"</div>";
				}
				...
				if(d.status === "success")
				{
					...
					$("#property-page-1").html(
						"<div>" +
						(!d.data.Hms ?
						"<button style='font-family: varela_roundregular;' class='ui disabled button'>Property Managment</button>" :
							"<a href='' target='_blank'>" +
							"<button style='font-family: varela_roundregular;' class='ui blue button'>" +
							"Property Managment</button>" +
							"</a>")+
						(!d.data.Hms ?
						"<div class='ui w3-row info message'>" +
						"<div class='w3-col l9 m8 s12'>" +
						"Subscribe to get the full property management for" +
						"</div>" +
						"<div class='w3-col l3 m4 s12 align-r'>" +
						"<button class='ui blue small button' style='font-family: varela_roundregular;'>Get full hms</button>" +
						"</div>" +
						"</div>" : "") +
						"</div>" +
						...
						"<div class='pad-t'>" +
						"<img src='../files/"+d.data.Banner+"' style='width: 100%;'/>" +
						"</div>" +
						"</div>" + gallery +
						"</div>");

					$("#property-page-2").html(
						"<div class=''>" +
						"<div>" +
					...
					if(d.reviews.length === 0)
					{
						$("#review-con").html(
							...
							"<h3 class='sleak' style='color: lightgray;'>There are no reviews yet</h3>" +
							"</div>"
						);
					}
					...
					let review = (d.reviews.length == 0 ? "0.0" : (revv / d.reviews.length).toFixed(1));
					...
					for(let i = 0; i < d.reviews.length; i++)
					{
						...
						con.innerHTML =
							...
							"</h6>" +
							"<h6 class='blue-text' style='font-family: varela_roundregular; color: dimgray;'>" +
							"<i class='user circle blue icon'></i>"+
							d.reviews[i].Customer.Name+" "+d.reviews[i].Customer.Surname+
							"</h6>" +
							"</div>" +
							...
							"</div>" +
							"<br/>" +
							"<p style='font-family: Lato; color: dimgray; line-height: 170%; font-size: 16px;'>"+d.reviews[i].Body+"</p>" +
							"</div><hr/>";
					...
					$("#property-side-1").html(
						...
						"<img src='../images/calendar_1.png' style='width: 50px;'/>" +
						"</div>" +
						"<div class='w3-col l7 m7 s7 align-r'>" +
						"<h5 style='font-family: varela_roundregular; margin: 0; color: dimgray;'>Reservations</h5>" +
						"<h6 class='sleak' style='margin: 0; margin-top: 5px;'>"+(d.reservartions)+"</h6>" +
						"</div>" +
						"</div>" +
						"<div class='w3-row' style='margin-top: 30px;'>" +
						"<div class='w3-col l5 m5 s5'>" +
						"<img src='../images/view.png' style='width: 50px;'/>" +
						"</div>" +
						"<div class='w3-col l7 m7 s7 align-r'>" +
						"<h5 style='font-family: varela_roundregular; margin: 0; color: dimgray;'>Views</h5>" +
						"<h6 class='sleak' style='margin: 0; margin-top: 5px;'>"+(d.data.Views)+"</h6>" +
						"</div>" +
						"</div>" +
						"<div class='w3-row' style='margin-top: 30px;'>" +
						"<div class='w3-col l5 m5 s5'>" +
						"<img src='../images/sms.png' style='width: 50px;'/>" +
						"</div>" +
						"<div class='w3-col l7 m7 s7 align-r'>" +
						"<h5 style='font-family: varela_roundregular; margin: 0; color: dimgray;'>New message(s)</h5>" +
						"<h6 class='sleak' style='margin: 0; margin-top: 5px;'>"+(d.messages)+"</h6>" +
						"</div>" +
						"</div>" +
						"<div class='w3-row' style='margin-top: 30px;'>" +
						"<div class='w3-col l5 m5 s5'>" +
						...
						"</div>" +
						"<div class='w3-col l7 m7 s7 align-r'>" +
						"<h5 style='font-family: varela_roundregular; margin: 0; color: dimgray;'>Review</h5>" +
						"<h6 style='margin: 0; margin-top: 5px; font-family: varela_roundregular;'>"+review+"</h6>" +
						"</div>" +
						"</div>" +
						"</div>");

					$("#property-side-2").html(
						"<div class=''>" +
						"<div>" +
						"<h3 style='font-family: varela_roundregular;'>My Property data</h3>" +
						"</div>" +
						"<hr/>" +
						"<div class='w3-row'>" +
						"<div class='w3-col l5 m5 s5'>" +
						"<img src='../images/city.png' style='width: 30px;'/>" +
						"</div>" +
						"<div class='w3-col l7 m7 s7 align-r'>" +
						"<h4 style='font-family: varela_roundregular; margin: 0; color: dimgray;'>City</h4>" +
						"<h6 class='sleak' style='margin: 0; margin-top: 5px;'>"+d.data.Cityname+"</h6>" +
						"</div>" +
						"</div>" +
						"<div class='w3-row' style='margin-top: 30px;'>" +
						"<div class='w3-col l5 m5 s5'>" +
						"<img src='../images/map_marker.png' style='width: 30px;'/>" +
						"</div>" +
						"<div class='w3-col l7 m7 s7 align-r'>" +
						"<h4 style='font-family: varela_roundregular; margin: 0; color: dimgray;'>State</h4>" +
						"<h6 class='sleak' style='margin: 0; margin-top: 5px;'>"+d.data.Statename+"</h6>" +
						"</div>" +
						"</div>" +
						"<div class='w3-row' style='margin-top: 30px;'>" +
						"<div class='w3-col l5 m5 s5'>" +
						"<img src='../images/country.png' style='width: 30px;'/>" +
						"</div>" +
						"<div class='w3-col l7 m7 s7 align-r'>" +
						"<h4 style='font-family: varela_roundregular; margin: 0; color: dimgray;'>Address</h4>" +
						"<h6 class='sleak' style='margin: 0; margin-top: 5px;'>"+d.data.Address+"</h6>" +
						"</div>" +
						"</div>" +
						"<div class='w3-row' style='margin-top: 30px;'>" +
						"<div class='w3-col l5 m5 s5'>" +
						"<img src='../images/phone.png' style='width: 30px;'/>" +
						"</div>" +
						"<div class='w3-col l7 m7 s7 align-r'>" +
						"<h4 style='font-family: varela_roundregular; margin: 0; color: dimgray;'>Phone</h4>" +
						"<h6 class='sleak' style='margin: 0; margin-top: 5px;'>"+d.data.Phone1+"</h6>" +
						"</div>" +
						"</div>" +
						"<div class='w3-row' style='margin-top: 30px;'>" +
						"<div class='w3-col l5 m5 s5'>" +
						...
						"<h6 class='sleak' style='margin: 0; margin-top: 5px; word-wrap: break-word;'>"+d.data.Email1+"</h6>" +
						"</div>" +
						"</div>" +
						"</div>");
				...
				if(d.status === "success")
				{
					...
					if(d.data.length === 0)
					{
						$("#table-body").html("<tr><td colspan='7'><div class='align-c pad-2'>" +
							"<img src='../images/empty_box2.png' style='width: 60px;'/>" +
					...
					for(let i = 0; i < d.data.length; i++)
					{
						...
						td6.innerHTML = "<div class='w3-container'> " +
							...
							"<div class='item' onclick=\"ConfirmReservationDelete('" + d.data[i].Id + "')\"><i class='trash icon'></i>Cancel reservation</div>" +
							"</div>" +
							"</div></div>";
		...
		postJson("hms-admin/worker", function(data, status){
			...
			if(status === "done")
			{
				...
				if(d.status === "success")
				{
					...
					$("#res-phone").html(d.data.Customer.Phone);
					$("#res-email").html(d.data.Customer.Email);
					...
					else if((d.data.Status == "due") && (!d.data.Noshow))
					{
					...
					for(let i = 0; i < d.data.Rooms.length; i++)
					{
						...
						con.innerHTML =
							...
							"<img src='../files/"+d.data.Rooms[i].Room.Images[0]+
	...
	function populateGuests(page)
	{
		...
		postJson("hms-admin/worker", function(data, status){
			...
			if(status === "done")
			{
				...
				{
					$("#table-body").html("<tr><td colspan='9'><div class='align-c pad-2'>" +
						"<img src='../images/code.png' style='width: 60px;'/>" +
			...
			{
				$("#table-body").html("<tr><td colspan='9'><div class='align-c pad-2'>" +
					"<img src='../images/ban.png' style='width: 60px;'/>" +
				...
				if(d.status === "success")
				{
					if(d.data.Profilepic == "")
					{
						$("#profile-img-con").html(
							"<div class='pad-4'>" +
							"<img id='profile-img' src='../images/customer.png' style='max-width: 100%;'/>" +
							"</div>");
					}
					else
					{
		...
		postJson("hms-admin/worker", function(data, status){
			...
			if(status === "done")
			{
				...
				if(d.status === "success")
				{
					...
					{
						$("#table-body").html("<tr><td colspan='9'><div class='align-c pad-2'>" +
						"<img src='../images/bed.png' style='width: 60px;'/>" +
